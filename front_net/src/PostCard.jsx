  ...
  stats: { likes, comments, views, shares, saves }
    ...
    >
      ...
      {/* Stats */}
        ...
        <div className="flex items-center gap-1 flex items-center space-x-4">
          <span className="flex items-center gap-1 raleway-font text-[14px] text-gray-500">
            <svg width="18" height="18" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M6.775 1.5C3.58562 1.5 1 4.08259 1 7.26822C1 13.0364 7.825 18.2803 11.5 19.5C15.175 18.2803 22 13.0364 22 7.26822C22 4.08259 19.4144 1.5 16.225 1.5C14.272 1.5 12.5447 2.46854 11.5 3.95097C10.9674 3.19344 10.2599 2.5752 9.43746 2.14857C8.615 1.72194 7.70176 1.49948 6.775 1.5Z" fill="#BBBBBE" stroke="#BBBBBE" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            {likes.toLocaleString()} тис.
          </span>
          <span className=" flex items-center gap-1 raleway-font text-[14px] text-gray-500">
