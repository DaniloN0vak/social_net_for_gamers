        ...
        <main style={{
            ...
            <div style={{
                ...
                <PostCard
                    ...
                    stats={{ likes: 10, comments: 0, views: 50, shares: 1, saves: 8 }} />
                ...
                <PostCard
                    ...
                    stats={{ likes: 12, comments: 0, views: 52, shares: 15, saves: 8 }} />
                    ...
                    stats={{ likes: 100, comments: 0, views: 50, shares: 1, saves: 8 }} />
                    ...
                    stats={{ likes: 159, comments: 0, views: 500, shares: 293, saves: 87 }} />
            </div>
        </main>
   {/* <div className="p-4">
      <CreatePost />
