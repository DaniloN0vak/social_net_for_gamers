...
const PostCard = ({
  ...
  if (isSaved(id)) {
    ...
    return (
    <div className="post-card raleway-font">
      {/* Header */}
      <div className="post-header raleway-font">
        {avatar ? (
        ...
        <div>
          <p className="post-username raleway-font">{username}</p>
          <p className="post-date raleway-font">{dateTime}</p>
        </div>
      </div>

      {/* Text */}
      <p className="raleway-font post-text">{text}</p>

      {/* Tags */}
      <div className="post-tags">
        {tags.map((tag, i) => (
          <span key={i} className=" raleway-font tag">#{tag}</span>
        ))}
      </div>
